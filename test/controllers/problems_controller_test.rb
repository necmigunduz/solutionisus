...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { problem_explanation: @problem.problem_explanation, problem_title: @problem.problem_title } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { problem_explanation: @problem.problem_explanation, problem_title: @problem.problem_title } }
